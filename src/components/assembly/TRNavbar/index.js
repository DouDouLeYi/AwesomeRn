  ...
  render() {
    ...
    return (
      <View
        ...
        <View style={[styles.flex, styles.navMarginTop]}>
...
var styles = StyleSheet.create({
  ...
  navMarginTop: {
    marginTop: isAndroid ? 0 : NavConfig.top,
    borderBottomColor: '#F4F4F4',
    borderBottomWidth: 0,
  },
  middleCenter: {flexDirection: 'row', alignItems: 'center'},
  flex: {flex: 1, paddingHorizontal: px2dp(5)},
  title: {
    fontSize: px2dp(34),
