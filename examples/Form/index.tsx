...
export default class FormScreen extends Component<{}, any> {
  ...
  render() {
    ...
    return (
      <ScrollView testID="scroller" style={styles.body}>
        <Text style={styles.header}>基本信息</Text>
        <Form testID="form" ref={ref => (this.form = ref)}>
          <Form.Item
            ...
            label={
              <View
                ...
                <Text style={{color: variables.mtdBrandDanger, marginRight: 2}}>
                  *
                </Text>
                <Text>姓名</Text>
                <Icon
                  ...
                  size={14}
                  tintColor={variables.mtdGrayLighter}></Icon>
              </View>
            }
            hasLine>
            <Input
            ...
            {validateResults.name && !validateResults.name.valid ? (
              <Text testID="nameInfo" style={{color: variables.mtdBrandDanger}}>
                {validateResults.name.msg}
              </Text>
            ) : null}
          </Form.Item>
          <Form.Item style={{paddingVertical: 13}} label="手机号码" hasLine>
            ...
            {validateResults.phone && !validateResults.phone.valid ? (
              <Text
                testID="phoneInfo"
                style={{color: variables.mtdBrandDanger}}>
                {validateResults.phone.msg}
              </Text>
            ) : null}
            <Text
              style={{
          ...
          <Form.Item style={{paddingVertical: 0}} label="日期" hasLine>
            <TouchableOpacity
              ...
              <Text style={{color: variables.mtdGray, marginRight: 5}}>
                {filters.date ? filters.date : ' 请点击选择'}
              </Text>
              {filters.date ? (
                <TouchableOpacity
