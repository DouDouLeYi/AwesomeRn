...
export default class SlideModalScreen extends Component<any, any> {
  ...
  render() {
    ...
    const contentEl = (
      <View style={{backgroundColor: '#fff', width: 50, height: 40}}></View>
    );
      ...
      <ScrollView style={styles.body} contentContainerStyle={styles.container}>
        ...
        <SlideModal<SlideModalProps>
          ...
          onClosed={(...args) => {
            ...
            this.setState({
              directionIndex:
                (this.state.directionIndex + 1) % directonsWithAlign.length,
            });
          }}>
        ...
        <Button
          ...
          onPress={() => {
            console.log('this.btnEl5.measure', this.btnEl5);
