    ...
    return (
      <ScrollView style={styles.body}>
        ...
        <View style={styles.panel}>
          ...
          {this.state.count ? (
            <Text testID="text">点击了按钮 {this.state.count}</Text>
          ) : null}
        </View>
        ...
        <View style={styles.panel}>
          ...
          <View style={componentStyles.row}>
            ...
            <Button style={[componentStyles.spacingV]} type="default" size="md">
              默认尺寸
            </Button>
          </View>
          ...
          <Button type="primary" size="md" textColorInverse>
            默认尺寸拉伸
          </Button>
        </View>
        ...
        <View style={styles.panel}>
          <View style={[componentStyles.row, {alignItems: 'center'}]}>
            ...
            <Button style={[componentStyles.spacingH]} type="info" size="sm">
            ...
            <Button
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Icon
                  type="plus-circle-o"
                  tintColor={variables.mtdBrandPrimaryDark}></Icon>
                <Text
                  style={{color: variables.mtdBrandPrimaryDark, marginLeft: 5}}>
                  新增
                </Text>
              </View>
            </Button>
