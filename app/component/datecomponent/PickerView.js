...
class PickerView extends BaseComponent {
  ...
  constructor(props) {
    ...
    this.parentTopY = props.parentTop
      ? props.parentTop
      : this.mScreenHeight - props.itemHeight * 5 - this.getSize(15);
    this.parentBottomY = props.parentBottom
      ? props.parentBottom
      : this.mScreenHeight - this.getSize(15);
  }
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (nextProps) {
      ...
      if (listChange || indexChange) {
        ...
        if (listChange || nextProps.isChange) {
          this.colorPath = [];
          let length = list.length;
          for (let i = 0; i < length; i++) {
            this.colorPath.push(
